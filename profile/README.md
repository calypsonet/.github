# Welcome to Calypso Networks Association (CNA)
...
### Our Mission
Our goal is to empower transport authorities and operators by providing secure, standardized frameworks for contactless ticketing. By promoting collaborative innovation, we ensure that the future of mobility is open, secure, and consumer-centric.
...
*   **Eclipse Keyple®** and **Keypop**: These are independent projects hosted by the **Eclipse Foundation**. While CNA is a major contributor to their development, they remain under the governance of the Eclipse Foundation.
...
---
[calypsonet.org](https://www.calypsonet.org) | [Keyple Support](https://keyple-support.calypsonet.org/) | [Contact Us](https://www.calypsonet.org/contact/)
